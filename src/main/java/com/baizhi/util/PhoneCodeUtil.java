...
public class PhoneCodeUtil {
    ...
    public static SendSmsResponse getMsg(String phoneNumbers,String signName,String templateCode,String templateParam ) throws Exception{
        ...
        //替换成你的AK
        final String accessKeyId = "LTAI2QJkl6lfghEL";//你的accessKeyId,参考本文档步骤2
        final String accessKeySecret = "uyNTajCRQ3I724oAg2LiQ6Cdp9EbhP";//你的accessKeySecret，参考本文档步骤2
    ...
    public static String getPhoneMessage(String phone){
        ...
        String redomCode = getCode();
        //将验证码随机数存储起来,方便后期做校验

        String message=null;
        try {
            SendSmsResponse messages = getMsg(phone, "小团团", "SMS_172008200", "{\"code\":\""+redomCode+"\"}");
    ...
    /*public static void main(String[] args) {
        String message = getPhoneMessage("13720990211");
